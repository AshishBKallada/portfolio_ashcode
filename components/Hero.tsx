...
export default function Hero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (heroImage) gsap.set(heroImage, { opacity: 0, scale: 1.06, y: 28 });
  ...
  useEffect(() => {
    ...
    const lineEls = Array.from(root.querySelectorAll<HTMLElement>(".hero-line"));
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[20] pointer-events-none">
        <div className="hero-image-inner absolute bottom-0 left-1/2 z-[1] h-[min(72vh,520px)] w-[min(96vw,1100px)] -translate-x-1/2 will-change-transform">
          <Image
            src={HERO_IMAGE}
            alt=""
            fill
